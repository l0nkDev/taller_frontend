            ...
            >
              <YStack f={1} minWidth={800}>
                <XStack bg="$gray3" p="$3" borderBottomWidth={1} boc="$cardBorder" ai="center">
                  ...
                  <Text f={1} fb={0} minWidth={100} fontWeight="bold" fos="$3">
                    Orden #
                  </Text>
                  <Text f={3} fb={0} minWidth={300} fontWeight="bold" fos="$3">
                    Ítems
                  </Text>
                  <Text f={1} fb={0} minWidth={100} fontWeight="bold" fos="$3">
                    Método
                  </Text>
                  <Text f={1.2} fb={0} minWidth={120} fontWeight="bold" fos="$3" ta="right">
                    Total (Bs.)
                  </Text>
                </XStack>
