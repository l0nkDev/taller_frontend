...
import { XStack, YStack, Select, Circle, Text, ScrollView } from 'tamagui';
        ...
        >
          <YStack minWidth={800} f={1} width="100%">
            <XStack
              ...
              ai="center"
            >
              <Text f={2.5} fb={0} minWidth={250} fos="$5" fontWeight="bold" color="$secondaryText">
                Usuario
              </Text>
              <Text f={1.5} fb={0} minWidth={150} fos="$5" fontWeight="bold" color="$secondaryText">
                Contacto
              </Text>
                ...
                data
                  ...
                  .map((user, index) => (
                    ...
                    >
                      ...
                      <XStack f={1.5} fb={0} minWidth={150} ai="center" gap="$3">
                        <Text fos="$5" color="$secondaryText">
                          {user.phone}
                        </Text>
                      </XStack>
                      <XStack f={1.2} fb={0} minWidth={120}>
                      ...
                      {user.is_active ? (
                        <XStack f={1} fb={0} minWidth={100} jc="center" gap="$2">
